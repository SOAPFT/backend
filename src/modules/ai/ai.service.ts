...
export class AiService {
  ...
  private buildAnalysisPrompt(
    ...
    return `
당신은 챌린지 인증 이미지를 분석하는 AI입니다. 사용자가 업로드한 이미지가 다음 챌린지 요구사항을 만족하는지 판단해주세요.
...
**분석 후 응답 형식 (JSON):**
{
  ...
  "confidence": 0-100,
  "reasoning": "간결한 피드백 메시지 (한 문장으로)",
  "suggestedAction": "approve/reject/review"
}

**reasoning 작성 가이드:**
- approve: "[구체적 요소]가 확인되어 인증되었습니다"
- reject: "[부족한 요소]가 확인되지 않습니다"
- review: "[애매한 부분]으로 인해 추가 검토가 필요합니다"

**예시:**
- 런닝 챌린지 승인: "운동복과 달리기 모습이 명확히 확인되어 인증되었습니다"
- 런닝 챌린지 거절: "달리기와 관련된 활동이 확인되지 않습니다"
- 런닝 챌린지 검토: "운동복은 확인되나 실제 달리기 활동이 명확하지 않아 추가 검토가 필요합니다"

이미지를 분석하고 사용자에게 보여줄 간결한 한국어 피드백을 reasoning에 작성하여 JSON으로만 응답해주세요.
  `;
  }
