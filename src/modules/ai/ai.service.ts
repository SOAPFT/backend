...
**분석 기준:**
1. 이미지가 챌린지 주제와 직접적으로 관련이 있는가?
2. 인증 가이드에 명시된 요소들이 이미지에 포함되어 있는가?
...
**예시:**
- 런닝 챌린지: 운동화, 러닝 트랙, GPS 앱 화면, 운동 중인 모습 → approve
- 런닝 챌린지: 음식 사진, 실내 풍경, 관련 없는 셀피 → reject
- 애매한 경우 (운동복만 있고 실제 운동 여부 불분명) → review

이미지를 분석하고 JSON 형식으로만 응답해주세요.
    `;
  }
